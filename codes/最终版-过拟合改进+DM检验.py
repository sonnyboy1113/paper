...
class OverfittingDetector:
    ...
    def generate_report(self):
        ...
        print(f"\n💡 关键结论:")
        print(f"  - 策略模型（XGBoost/Ridge）仅学习残差，影响有限")
...
print(f"✓ R^2: {r2_dynamic:.4f} (vs简单平均: {r2_dynamic - avg_r2:+.4f})")
...
print(f"✓ R^2: {r2_ridge:.4f} (vs简单平均: {r2_ridge - avg_r2:+.4f})")
...
key_strategies_for_plot = [
    ...
    ('策略8-Ridge残差', strategies_original['策略8-Ridge残差'], 'red'),
]
